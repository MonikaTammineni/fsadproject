...
const PatientsList: React.FC = () => {
  ...
  return (
    <div className="p-6 bg-white dark:bg-gray-900 rounded-lg shadow-lg h-full">
      <h2 className="text-2xl font-semibold text-center text-gray-800 dark:text-white mb-4">Patients List</h2>
            ...
            {sortedPatients.length === 0 ? (
              ...
              sortedPatients.map((p) => (
                ...
                >
                  ...
                  <td className="p-2 text-gray-900 dark:text-gray-100">{p.status ? 'Active' : 'Inactive'}</td>
